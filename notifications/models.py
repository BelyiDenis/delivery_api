...
class Notification(models.Model):
    PROBLEM_CHOICES = [('delay', 'Delay'), ('breakdown', 'Breakdown'), ('client_refusal', 'Client Refusal'), ('other', 'Other')]
    STATUS_CHOICES = [('new', 'New'), ('read', 'Read')]
    
    id_notification = models.AutoField(primary_key=True)
    id_delivery_request = models.ForeignKey(DeliveryRequest, on_delete=models.CASCADE, db_column='id_delivery_request')
...
class UrgentNotification(models.Model):
    STATUS_CHOICES = [('sent', 'Sent'), ('processed', 'Processed')]
